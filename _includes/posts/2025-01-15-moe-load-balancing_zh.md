...
### 3.4 Mixtral 8x7B：时间局部性与专门的稀疏 Kernel
...
### 4.1 OpenMoE：上下文无关的“专长化”与末端 Token 的“掉队”问题
...
### 4.3 JetMoE：无 Token 丢弃的 MoE 与流水线并行
...
### 4.4 Skywork-MoE：gating logit 归一化 & 自适应辅助损失
