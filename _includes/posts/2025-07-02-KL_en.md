# Re-understanding KL Approximation from an RL-for-LLM Lens: Notes After Reading “Approximating KL Divergence”
...
In this section, I’m imagining readers who haven’t read the original post yet, so let’s quickly pass through the most important bits. Put simply, the post is about how—when we can’t directly compute KL divergence—we can build reasonable Monte Carlo–style estimators for it.
